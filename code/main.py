...
def train_cartpole(random_seed: int=42):
    ...
    result_filename = 'correct_cartpole_' + 'standard_' + str(random_seed) + '_' + str(max_step)
    save_result(scores, result_filename, 'CartPole-v1, Standard-DQN')
    ...
    result_filename = 'correct_cartpole_' + 'minimax_' + str(random_seed) + '_' + str(max_step)
...
def train_mountaincar(random_seed: int=42):
    ...
    result_filename = 'correct_mountaincar_' + 'standard_' + str(random_seed) + '_' + str(max_step)
    ...
    result_filename = 'correct_mountaincar_' + 'minimax_' + str(random_seed) + '_' + str(max_step)
